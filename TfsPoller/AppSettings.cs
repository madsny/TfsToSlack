...
namespace TfsPoller
{
    internal class AppSettings : ITfsConfiguration, ISlackConfiguration, ITfsPollerConfiguration
    {
        ...
        public string SlackDefaultChannel => GetAppsettingsString("slack.defaultchannel") ?? "#general";
        public string SlackFailedChannel => GetAppsettingsString("slack.failedchannel") ?? "#general";
